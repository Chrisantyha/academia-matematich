...
export default function CrearExamenFinalPage() {
  ...
  const [titulo, setTitulo] = useState('Examen final del curso')
  ...
  useEffect(() => {
    async function cargarExistente() {
      // El examen final se identifica como la evaluacion del curso que
      // NO tiene modulo_id (a diferencia de las evaluaciones de modulo).
  ...
  async function guardarEvaluacion() {
    ...
    alert(evaluacionId ? 'Examen final actualizado correctamente' : 'Examen final guardado correctamente')
      ...
      <div className="max-w-3xl mx-auto px-8 py-12">
        ...
        <div className="mb-8">
          <div className="text-yellow-500 text-xs font-bold uppercase tracking-widest mb-2">
            {evaluacionId ? 'Editar examen final' : 'Crear examen final'}
          </div>
          <h1 className="text-3xl font-bold">
            {evaluacionId ? 'Editar examen final del curso' : 'Nuevo examen final del curso'}
          </h1>
          <p className="text-slate-400 mt-2 text-sm">
            Este examen es requisito para emitir el certificado. Puedes usar LaTeX en las preguntas. Ejemplo: $x^2$ o $$\frac{"{x}"}{"{2}"}$$
          </p>
        </div>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 mb-6">
          ...
          <div className="mb-4">
            ...
            <input
              ...
              placeholder="Ej: Examen final — Cálculo Diferencial"
        ...
        <div className="flex gap-3">
          ...
          >
            {guardando ? 'Guardando...' : evaluacionId ? 'Guardar cambios' : 'Guardar examen final'}
          </button>
          <button
            onClick={() => router.back()}
